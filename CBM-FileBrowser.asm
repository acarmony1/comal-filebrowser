...
!if (target = 64 | target = 128) & key_quit < 255  & variant != 3 {
...
!if (target = 64 | target = 128) & key_reset < 255  & variant != 3 {
++ cpx #key_reset
bne ++              ; jump if not
...
!if target = 64 | target = 16 & variant != 3 {
...
main1 lda (selected),y
beq +
jsr CHROUT		; print to screen filename
iny
cpy #entrylen
bne main1
...
sta kbuf,y			; send text to keyyboard buffer
iny
cpy #runtextlen
bne main2
